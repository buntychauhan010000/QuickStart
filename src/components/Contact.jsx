  ...
  return (
    <div id="contact" className="container mx-auto px-4 py-16 mb-15">
      ...
      <div className="lg:flex justify-between items-center gap-5">
        {/* Address Card */}
        <div className="lg:w-1/2 shadow-card shadow-gray-300 px-5 py-8 my-4 lg:my-0">
          <div className="flex flex-col gap-4 items-center">
            <button className=" border-dashed border-2 border-primary p-5 w-fit rounded-full">
              <BsGeoAlt className="text-primary text-2xl" />
            </button>
            <h3 className="text-lg text-gray-600 font-bold font-nunito">Address</h3>
        ...
        <div className="lg:w-1/2 flex gap-5">
          ...
          <div className="flex flex-col gap-4 items-center w-full shadow-card shadow-gray-300 px-5 py-8">
            ...
            <h3 className="text-lg text-gray-600 font-bold font-nunito">Call Us</h3>
          ...
          <div className="flex flex-col gap-4 items-center w-full shadow-card shadow-gray-300 px-5 py-8">
            ...
            <h3 className="text-lg text-gray-600 font-bold font-nunito">Email Us</h3>
      ...
      <div className="flex gap-5 justify-between items-center flex-col lg:flex-row">
        {/* Embedded Google Map */}
        <div className="w-full lg:w-1/2 shadow-card shadow-gray-300 mt-10">
          <iframe
        ...
        <div className="w-full lg:w-1/2 mt-10 shadow-card">
          <ContactForm />
        </div>
      </div>
    </div>
