  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-between items-center flex-col md:flex-row mt-10">
        {/* Features List */}
        <div className="md:w-3/5 xl:w-2/5 p-4">
          {featuresdata.map((feature, i) => (
            <article key={i} data-aos="fade-up" data-aos-delay={i * 100}>
              <div className="flex lg:gap-5 py-2 lg:py-4 hover:bg-primary-lite transition-all duration-300 p-3 lg:p-5 lg:my-5">
                ...
                <div>
                  ...
                  <p className="text-sm line-clamp-2 text-secondary">{feature.lorem}</p>
                </div>
              </div>
            </article>
          ))}
        ...
        {/* Right Side Image */}
        <div data-aos="fade-up" data-aos-delay="60" className="w-4/5 md:w-2/5">
          <img
