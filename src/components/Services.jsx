      ...
      <div className="container mx-auto px-4 py-15">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-10">
          {servicesdata.map((item, index) => (
            <article
              key={index}
              className="flex items-start gap-5 p-3 sm:p-6 border border-gray-200 hover:shadow-card duration-300 rounded-lg bg-white"
            >
              <div
                ...
                style={{
                  ...
                  backgroundColor: `${item.color}20`, // light bg
                }}
              >
                {item.icon}
              </div>
